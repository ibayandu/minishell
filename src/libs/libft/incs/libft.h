...
/*   Updated: 2025/04/13 19:54:08 by yzeybek          ###   ########.tr       */
/*                                                                            */
/* ************************************************************************** */
...
char				*ft_substr(t_memblock **head, char const *s,
						unsigned int start, size_t len);
char				*ft_strjoin(t_memblock **head, char const *s1,
						char const *s2);
char				*ft_strtrim(t_memblock **head, char const *s1,
						char const *set);
...
t_list				*ft_lstmap(t_memblock **head, t_list *lst,
